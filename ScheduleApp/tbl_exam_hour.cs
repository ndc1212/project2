...
namespace ScheduleApp
{
    ...
    public partial class tbl_exam_hour
    {
        ...
        {
            this.tbl_semester_subject_exam_hour = new HashSet<tbl_semester_subject_exam_hour>();
        ...
        public Nullable<long> exam_date_id { get; set; }
        public Nullable<long> exam_type { get; set; }
        public Nullable<int> view_index { get; set; }
    
        public virtual tbl_exam_date tbl_exam_date { get; set; }
